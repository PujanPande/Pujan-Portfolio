const socialLinks=[
     {
    href: 'https://github.com/PujanPande',
            ...
            lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    max-w-[50ch] lg:max-w-[30ch]">
                        If you have any questions or want to collaborate, feel free to reach out to me through the contact form below or connect with me on social media.
                    </p>
                ...
                <form 
                action="https://getform.io/f/bgdlkyqa"
                method="POST"
                            ...
                            <label htmlFor="name"
                             ...
                             <input type="email"
                              name="email"
                               ...
                               autoComplete="email"
                               required
                               placeholder="pujanpandey@example.com"
                               className="text-field"
                               />
                        </div>
                    </div>
